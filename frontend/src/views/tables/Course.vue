  ...
  <div>
    ...
    <div class="container">
      ...
      <el-table
        ...
        <el-table-column prop="credit" label="课时" align="center" />
        <el-table-column prop="period" label="学分" align="center" />
    ...
    <el-dialog :title="`${addOrUpdate ? '添加课程信息' : '编辑课程信息'}`" v-model="showDialog" width="30%">
      <el-form label-width="100px" ref="formRef" :model="formData" :rules="formRules"
        ...
        <el-form-item label="课时" prop="credit">
          <el-input v-model="formData.credit" placeholder="课时"></el-input>
        </el-form-item>
        <el-form-item label="学分" prop="period">
          <el-input v-model="formData.period" placeholder="学分"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
