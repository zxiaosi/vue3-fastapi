...
from apis.common import upload, student, teacher, selectCourse, department, major, course
...
app_router.include_router(selectCourse.router, prefix="/selectCourse", tags=["selectCourse"])
