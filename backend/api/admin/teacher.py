...
def read_teacher(*, db: Session = Depends(get_db), id: int, current_user: Admin = Depends(get_current_user)) -> Any:
...
def delete_teacher(*, db: Session = Depends(get_db), id: int, current_user: Admin = Depends(get_current_user)) -> Any:
...
def get_teacher_relation(db: Session = Depends(get_db), current_user: Admin = Depends(get_current_user)) -> Any:
