...
def read_department(db: Session = Depends(get_db), id: int = None) -> Any:  # id为整型防止输入字符串
...
@router.get("/relation/", response_model=ResultPlusModel[List[Relation]], summary='获取到 院系表 中的关系字段')
